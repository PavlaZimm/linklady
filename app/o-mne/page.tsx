...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "AboutPage",
      "@id": "https://www.linklady.cz/o-mne/#webpage",
      url: "https://www.linklady.cz/o-mne",
      ...
      mainEntity: { "@id": "https://www.linklady.cz/#person" },
      inLanguage: "cs",
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: "O mně",
          item: "https://www.linklady.cz/o-mne",
        },
      ],
    },
    {
      ...
      worksFor: { "@id": "https://www.linklady.cz/#business" },
      knowsAbout: [
        "SEO optimalizace",
        "AI agenti",
